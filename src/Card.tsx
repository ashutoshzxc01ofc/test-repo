...
const Card : React.FC<cardsProps>= (props) => {
    return (
      <div className="w-[31%] h-[352px] gap-2.5 p-[25px] rounded-large flex flex-col items-start  overflow-hidden backdrop-blur-[26.4px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(26.4px)_brightness(100%)] [background:linear-gradient(180deg,rgba(52.17,48.88,102,0.17)_0%,rgba(41.22,38.61,83.94,0.78)_49.65%,rgba(27.04,24.82,66.94,0.71)_100%)] border border-solid border-transparent 
      hover:border-orange-500 hover:overflow-hidden">
