  ...
  return (
    <div className="app-layout">
      ...
      <div className="h-full flex">
        <div
          className="w-1/2 flex items-center justify-center shadow bg-grey-light"
          // style={{
          //   backgroundColor: "var(--colors-grey-light)",
          // }}
        >
          <div
            className="w-8/12 p-4 bg-white text-miscellaneous-miscellaneous-text-3 rounded-small"
            style={
              {
        ...
        <div className="  flex items-center justify-center  w-1/2">
          <form className=" space-y-4  px-20 w-10/12 ">
            <div
              className="text-3xl font-semibold text-miscellaneous-miscellaneous-text-3 
"
              // style={{
              //   color: "var(--colors-miscellaneous-miscellaneous-text-3)",
              // }}
            ...
            <div
              className="text-sm  pb-4 font-medium cursor-pointer  underline underline-offset-2 text-miscellaneous-hyperlink
"
              // style={{
            ...
            <div>
              <div
                className="mb-2 text-base text-miscellaneous-miscellaneous-text-3"
                // style={{
                //   color: "var(--colors-miscellaneous-miscellaneous-text-3)",
                // }}
              >
              ...
              <label>
                <input
                  ...
                  name="email"
                  required
                  className="border w-full  p-2 bg-surface-surface border-surface-line text-type-secondary rounded-xsmall"
                  style={
                    {
            ...
            <div>
              ...
              <label>
                <input
                  ...
                  name="phone"
                  required
                  className="border p-2 w-full bg-surface-surface border-surface-line text-type-secondary rounded-xsmall"
                  style={
                    {
                      //  backgroundColor: "var(--colors-surface-surface)",
                      //   borderRadius: "var(--corner-radius-xs)",
            ...
            <div>
              <button
                type="submit"
                className="font-normal mt-8 w-full text-miscellaneous-miscellaneous-text-2 bg-interactive-default hover:bg-interactive-hover rounded-xxlarge"
                style={{
              ...
              >
                ...
                <div
                  className="text-sm font-medium -ml-5 text-interactive-default text-interactive-default"
                  // style={{
